...
const points = [
  {
    ...
    text: 'Projects are an essential part of the academic curriculum, aimed at developing students’ practical knowledge, research skills, and critical thinking abilities. They provide an opportunity for students to explore real-world problems and apply theoretical concepts in a meaningful way.',
  },
  {
    icon: 'bi-journal-text',
    text: 'Students undertake projects on various topics related to their field of study, including clinical practice, community health, healthcare management, and emerging trends in nursing and medical sciences.',
  },
  {
    icon: 'bi-graph-up-arrow',
    text: 'Through these projects, students learn important skills such as data collection, analysis, interpretation, report writing, and presentation. This hands-on experience enhances their problem-solving abilities and prepares them for professional challenges.',
  },
  {
    icon: 'bi-person-workspace',
    text: 'Projects are carried out under the guidance of experienced faculty, ensuring adherence to ethical standards and scientific methodology.',
  },
  {
    icon: 'bi-award-fill',
    text: 'Overall, project work helps in building confidence, innovation, and professional competence among students.',
  },
]
      ...
      <main className="min-vh-100 py-5">
        <div className="container" style={{ maxWidth: 1160 }}>
          ...
          <div className="d-flex align-items-center gap-3 mb-2">
            ...
            <span className="eyebrow-text">Academic Projects</span>
            <div className="eyebrow-line" />
          </div>
          ...
          <div className="main-card row g-0 mb-5">
            ...
            <div className="col-lg-4 illus-panel">
              ...
              <div className="illus-title">Projects</div>
              <div className="illus-sub">
                Enhancing knowledge through research, innovation, and practical application.
              </div>
            </div>
            ...
            <div className="col-lg-8 p-4">
              ...
              <Link href="#image" className="btn lab-cta">
                View Project Work <i className="bi bi-image-fill ms-1" />
              </Link>
            </div>
          </div>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-9">
                <div className="video-card">
                  <img
                    src={`${ASSET_BASE}/videos/facility/Project.jpeg`}
                    alt="Project Work"
