...
const points = [
  {
    ...
    text: 'The Computer Lab is a well-equipped and modern facility designed to enhance students’ digital literacy and technical skills.',
  },
  {
    icon: 'bi-laptop-fill',
    text: 'It provides access to advanced computer systems, high-speed internet, and essential software applications for academic learning and professional development.',
  },
  {
    icon: 'bi-printer-fill',
    text: 'The lab is furnished with the latest computers, printers, projectors, and networking facilities for practical student activities.',
  },
  {
    icon: 'bi-gear-fill',
    text: 'Students are trained in basic computer operations, information technology, and healthcare-related software essential in digital healthcare environments.',
  },
  {
    icon: 'bi-shield-fill-check',
    text: 'A clean, safe, and well-organized atmosphere is maintained to ensure effective learning and smooth functioning.',
  },
  {
    icon: 'bi-mortarboard-fill',
    text: 'The Computer Lab prepares students to confidently use modern technology in both academic and clinical settings.',
  },
]
      ...
      <main className="min-vh-100 py-5">
        <div className="container" style={{ maxWidth: 1160 }}>
          ...
          <div className="d-flex align-items-center gap-3 mb-2 anim-1">
            ...
            <span className="eyebrow-text">Computer Lab</span>
            <div className="eyebrow-line" />
          </div>

          {/* ── Section Title ── */}
          <h2 className="section-title text-center mb-5 anim-1">
            Explore Our <em>Modern Computer</em> Lab
          </h2>
          ...
          <div className="main-card row g-0 mb-5">
            ...
            <div className="col-lg-4 illus-panel anim-2">
              ...
              <div className="illus-title">Computer Lab</div>
              <div className="illus-sub">
                Enhancing digital literacy & technical skills for students.
              </div>
              <div className="d-flex flex-wrap justify-content-center gap-2 mt-1">
                <span className="illus-badge"><i className="bi bi-laptop-fill me-1" />Digital Skills</span>
                <span className="illus-badge"><i className="bi bi-speedometer2 me-1" />High-Speed Internet</span>
                <span className="illus-badge"><i className="bi bi-printer-fill me-1" />Printing & Projection</span>
                <span className="illus-badge"><i className="bi bi-gear-fill me-1" />Software Training</span>
              </div>
            </div>
            ...
            <div className="col-lg-8 bg-white p-4 p-lg-5 d-flex flex-column justify-content-center position-relative">
              ...
              <div className="content-tag mb-3 anim-3">Digital Learning Facility</div>

              <h3 className="content-title mb-3 anim-3">
                Computer <span>Lab</span>
              </h3>

              <div className="divider mb-3 anim-3" />

              <p className="welcome-text mb-3 anim-3">
                Welcome to our modern Computer Lab.
              </p>
              ...
              <div className="col-lg-9 col-md-11">
                <div className="video-card">
                  <video
                    ...
                    playsInline
                    preload="metadata"
                    aria-label="Computer Lab video tour"
                    style={{ width: '100%' }}
                  >
                    <source
                      src={`${ASSET_BASE}/videos/facility/computerlab.mp4`}
                      type="video/mp4"
                    />
                  ...
                  <div className="video-label">
                    ...
                    <span>Computer Lab — Facility Tour</span>
                  </div>
                </div>
              </div>
            </div>
