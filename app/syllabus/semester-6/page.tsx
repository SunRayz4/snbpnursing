...
export default function SemesterFivePage() {
  const documents = [
    {
      title: "Child Health Nursing – II ",
      href: "/pdf/VI Semester/Child Health nursing II_201022.pdf",
    },
  
    {
      title: "Course of instruction  VI semester",
      href: "/pdf/VI Semester/Course of Instruction VI Semester_201022.pdf",
    },
    
      {
      title: "Mental Health Nursing-II",
      href: "/pdf/VI Semester/Mental health Nursing II_201022.pdf",
    },
      {
      title: "Midwifery Obstetrics and Gynaecology (OBG) Nursing I including SBA module",
      href: "/pdf/VI Semester/Midwifery Obstetrics and Gynaecology (OBG) Nursing I including SBA module_201022 (1).pdf",
    },
     {
      title: "Nursing Management and Leadership",
      href: "/pdf/VI Semester/Nursing Management and Leadership_201022.pdf",
    },
  ];
